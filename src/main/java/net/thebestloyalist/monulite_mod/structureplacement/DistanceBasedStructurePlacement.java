package net.thebestloyalist.monulite_mod.structureplacement;
...
import net.thebestloyalist.monulite_mod.MonuliteModStructurePlacements;
...
public class DistanceBasedStructurePlacement extends RandomSpreadStructurePlacement {
    ...
    public StructurePlacementType<?> type() {
        return MonuliteModStructurePlacements.DISTANCE_BASED_STRUCTURE_PLACEMENT.get();
    }
