package net.thebestloyalist.monulite_mod.structures;
...
import net.thebestloyalist.monulite_mod.MonuliteModStructures;
import net.thebestloyalist.monulite_mod.util.FilterHolderSet;
...
public class OceanStructures extends Structure {
    ...
    public StructureType<?> type() {
        return MonuliteModStructures.OCEAN_STRUCTURES.get(); // Helps the game know how to turn this structure back to json to save to chunks
    }
}